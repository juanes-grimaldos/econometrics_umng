...
```{r}
df %>% 
  filter(date >= as.Date("2022-04-09") & date <= as.Date("2023-01-09")) %>% 
...
chile %>% 
  ...
  annotate(geom = "text", x = as.Date("2022-03-27"), y = 1000, label = "post-COVID")+
    geom_label(data = chile %>% filter(Fecha == as.Date("2019-12-02")), 
             aes(label = Cierre), 
             size = 3, 
             color = "black", 
             fontface = "bold",
    ...
    geom_label(data = chile %>% filter(Fecha == as.Date("2020-12-01")), 
             aes(label = Cierre), 
             size = 3, 
             color = "black", 
             fontface = "bold",
      ...
      geom_label(data = chile %>% filter(Fecha == as.Date("2021-06-01")), 
             aes(label = Cierre), 
             size = 3, 
             color = "black", 
             fontface = "bold",
